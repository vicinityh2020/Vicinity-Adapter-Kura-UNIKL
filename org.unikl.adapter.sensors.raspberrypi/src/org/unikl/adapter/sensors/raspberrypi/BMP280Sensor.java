...
public class BMP280Sensor {
    ...
    // Constants
    public static final int BMP280_ADDRESS                       = 0x77 & 0xFFFF;// This addresses is returned by "sudo i2cdetect -y 1"
                        //BMP Registers
    ...
    //Constructors
    public BMP280Sensor(int addr) throws Exception {
    ...
    public BMP280Sensor() throws Exception {
        this(BMP280_ADDRESS);
    }
